...
public final class PKHUDAnimation {
    ...
    public static let discreteRotation: CAAnimation = {
        ...
        animation.values = [
            ...
            NSNumber(value: 1.0 * .pi / 6.0 as Float),
            NSNumber(value: 2.0 * .pi / 6.0 as Float),
            NSNumber(value: 3.0 * .pi / 6.0 as Float),
            NSNumber(value: 4.0 * .pi / 6.0 as Float),
            NSNumber(value: 5.0 * .pi / 6.0 as Float),
            NSNumber(value: 6.0 * .pi / 6.0 as Float),
            NSNumber(value: 7.0 * .pi / 6.0 as Float),
            NSNumber(value: 8.0 * .pi / 6.0 as Float),
            NSNumber(value: 9.0 * .pi / 6.0 as Float),
            NSNumber(value: 10.0 * .pi / 6.0 as Float),
            NSNumber(value: 11.0 * .pi / 6.0 as Float),
            NSNumber(value: 2.0 * .pi as Float)
        ]
        animation.keyTimes = [
            NSNumber(value: 0.0 as Float),
