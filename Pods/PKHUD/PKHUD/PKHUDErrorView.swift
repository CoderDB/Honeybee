...
open class PKHUDErrorView: PKHUDSquareBaseView, PKHUDAnimating {
    ...
    public func startAnimation() {
        ...
        dashOneLayer.transform = CATransform3DMakeRotation(-45 * CGFloat(Float.pi/180), 0.0, 0.0, 1.0)
        dashTwoLayer.transform = CATransform3DMakeRotation(45 * CGFloat(Float.pi/180), 0.0, 0.0, 1.0)
